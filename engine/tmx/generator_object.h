...
public: 
	...
	virtual void init(const std::map<std::string, std::string>& attrs, const std::string &data);
...
public: 
	...
	void init(const std::map<std::string, std::string>& _attrs, const std::string &data);
